...
namespace Voting.DAL.Migrations
{
    ...
    [Migration("20220423001915_forkeyfavmodel2")]
    partial class forkeyfavmodel2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voting.DAL.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Voting.DAL.Entities.Pair", b =>
                {
                    ...
                    b.HasOne("Voting.DAL.Entities.User", null)
                        .WithMany("Pairs")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Voting.DAL.Entities.User", b =>
                {
                    b.HasOne("Voting.DAL.Entities.Model", "FavoriteModel")
                        .WithMany()
                        .HasForeignKey("FavoriteModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FavoriteModel");
                });
